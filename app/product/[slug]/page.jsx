...
const productAccordionData = {
 "desi-jeera": {
    ...
    about: [
      ...
      { 
        type: "para", 
        text: "Today, **jeera drinks** have evolved into modern, ready-to-consume formats such as:" 
      },
      {
        type: "list",
        items: [
      ...
      { 
        type: "para", 
        text: "**Why It's Perfect for Summer:**" 
      },
      {
        type: "list",
        items: [
      ...
      { 
        type: "heading", 
        text: "Why Choose JC's Jeera Drink?" 
      },
      {
        type: "para",
